            ...
            <Card className="bg-gray-900/50 border-cyan-500/20 backdrop-blur-sm">
              <CardContent className="p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <p className="text-yellow-400 font-medium">Technical Head</p>
                    <p className="text-gray-400">GITAM University Literature Club</p>
                  </div>
                </div>
              </CardContent>
            </Card>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div className="space-y-6">
            <p className="text-lg text-gray-300 leading-relaxed">
              I'm currently seeking new opportunities. If you have a project in mind or just want to connect, feel free to
              reach out.
            </p>
            <div className="flex space-x-6">
              ...
              <a href="mailto:akarshsreedhar@gmail.com" className="text-gray-400 hover:text-cyan-400 transition-colors">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <Input name="name" placeholder="Your Name" required className="bg-gray-900/50 border-gray-700/50" />
            <Input name="email" type="email" placeholder="Your Email" required className="bg-gray-900/50 border-gray-700/50" />
            <Textarea name="message" placeholder="Your Message" required rows={5} className="bg-gray-900/50 border-gray-700/50" />
            <Button type="submit" disabled={isSubmitting} className="w-full bg-gradient-to-r from-cyan-500 to-purple-600 hover:from-cyan-600 hover:to-purple-700">
